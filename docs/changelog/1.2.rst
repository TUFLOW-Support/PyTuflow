...
- Older TUFLOW versions that sit within a ``w64`` subdirectory are correctly handled when checking binary versions.
...
- Encoding errors are now ignored when querying TUFLOW versions.
