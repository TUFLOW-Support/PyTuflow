...
class TabularOutput(Output):
    ...
    def __init__(self, *fpath: PathLike) -> None:
        ...
        #: :doc:`pytuflow.pytuflow_types.TuflowPath`: The path to the point GIS layer file
        self.gis_layer_p_fpath = None
        #: :doc:`pytuflow.pytuflow_types.TuflowPath`: The path to the line GIS layer file
        self.gis_layer_l_fpath = None
        #: :doc:`pytuflow.pytuflow_types.TuflowPath`: The path to the polygon GIS layer file
